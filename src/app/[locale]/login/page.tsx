        ...
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="glass-panel rounded-3xl p-8 shadow-2xl space-y-6 border border-white/5 bg-[#0d0f17]/80">
            ...
            <div className="space-y-2.5">
              <button onClick={handleGoogleLogin} disabled={googleLoading || fbLoading || loading}
              ...
              <button onClick={handleFacebookLogin} disabled={googleLoading || fbLoading || loading}
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-[#1877F2]/30 bg-[#1877F2]/10 hover:bg-[#1877F2]/20 text-sm font-semibold text-white transition-all disabled:opacity-50">
